...
presence_absence_sp_table = read_delim("DATA/euk_presence_absence_species_table.tsv", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
```{r}
ggsave(gg_htA1,filename = "./Graficas/Eukdetect_prevalence_species_global.svg",height = 20,width =20)
...
```{r}
ggsave(gg_htA2,filename = "./Graficas/Eukdetect_prevalence_species_species.svg",height = 20,width =20)
...
```{r}
ggsave(gg_htA3,filename = "./Graficas/Eukdetect_prevalence_species_lifestyle.svg",height = 20,width =20)
...
```{r}
ggsave(gg_htA4,filename = "./Graficas/Eukdetect_prevalence_species_continent.svg",height = 20,width =20)
...
```{r}
ggsave(gg_htA5,filename = "./Graficas/Eukdetect_prevalence_species_country.svg",height = 20,width =20)
